        ...
        <div className="w-full shrink-0 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm xl:w-80">
          ...
          <div className="mt-6 w-full max-w-full overflow-hidden">
            ...
            <select 
              ...
              // Added `block` and `truncate` to prevent layout stretching
              className="w-full block truncate rounded-lg border border-slate-300 px-3.5 py-2.5 text-sm text-slate-700 focus:border-[#004DD2] focus:outline-none focus:ring-1 focus:ring-[#004DD2] disabled:bg-slate-50 disabled:text-slate-400"
            >
