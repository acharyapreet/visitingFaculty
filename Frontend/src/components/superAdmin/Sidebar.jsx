...
export default function Sidebar({ active, onNavigate, onSignOut, pendingCount = 3 }) {
  ...
  return (
    // UPDATED: Removed w-full to ensure it respects the fixed width on mobile
    <aside className="w-[280px] shrink-0 bg-white border-r border-gray-200 flex flex-col justify-between min-h-screen">
      <div>
